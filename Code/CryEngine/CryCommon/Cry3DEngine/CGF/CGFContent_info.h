...
STRUCT_INFO_BEGIN(SCol)
VAR_INFO(icolor)
STRUCT_INFO_END(SCol)

STRUCT_INFO_BEGIN(SVF_P3H_C4B_T2H)
VAR_INFO(xyz)
VAR_INFO(color)
VAR_INFO(st)
STRUCT_INFO_END(SVF_P3H_C4B_T2H)

STRUCT_INFO_BEGIN(SVF_P3F_C4B_T2H)
STRUCT_VAR_INFO(xyz, TYPE_INFO(Vec3))
STRUCT_VAR_INFO(color, TYPE_INFO(UCol))
STRUCT_VAR_INFO(st, TYPE_INFO(Vec2f16))
STRUCT_INFO_END(SVF_P3F_C4B_T2H)
