...
// nv API
	...
	// AMD EXT (DX11 only)
		...
		#define AMD_API_HEADER "AMD/AGS Lib-5.1/inc/amd_ags.h"

		#if CRY_PLATFORM_64BIT
			#define AMD_API_LIB "SDKs/AMD/AGS Lib-5.1/lib/amd_ags_x64.lib"
		#else
			#define AMD_API_LIB "SDKs/AMD/AGS Lib-5.1/lib/amd_ags_x86.lib"
		#endif
	#endif
#endif
