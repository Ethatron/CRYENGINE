...
:VisitCompilers
set i=0
call :CheckCompiler %1 "HKEY_CLASSES_ROOT\VisualStudio.DTE.14.0" "Visual Studio 14 2015"
call :CheckCompiler %1 "HKEY_CLASSES_ROOT\VisualStudio.DTE.15.0" "Visual Studio 15 2017"
goto :eof
...
..\..\Tools\CMake\Win32\bin\cmake -D CMAKE_SYSTEM_VERSION=10.0 -D CMAKE_TOOLCHAIN_FILE=Tools\CMake\toolchain\windows\WindowsPC-MSVC.cmake ..\..
) ELSE (
echo Generating CMake solution for %1
..\..\Tools\CMake\Win32\bin\cmake -G %1 -D CMAKE_SYSTEM_VERSION=10.0 -D CMAKE_TOOLCHAIN_FILE=Tools\CMake\toolchain\windows\WindowsPC-MSVC.cmake ..\..
)
if ERRORLEVEL 1 (
PAUSE
) ELSE (
